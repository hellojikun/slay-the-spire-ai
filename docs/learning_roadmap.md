...
- As of 2026-07-05 after probe54, the cleaned training run loaded 221 card-pick examples and wrote 68 stable card-id deltas. `slay_ai.learn --reset` read 48 logs, applied 37 completed runs, and skipped 11 incomplete runs.
