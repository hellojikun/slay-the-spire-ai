...
Updated 2026-07-05 after the probe84 Guardian route/resource failure and current sub-agent capacity check.
...
| --- | --- | --- | --- |
| Archimedes | Flow / run-data agent | `019f30f8-ed4d-7bd3-9519-b3bcfda8116d` | Run frontier probes, accumulate climb logs, classify whether failures are clean/diagnostic/infra, and report concrete bottlenecks. Does not edit code. Current assignment: review probe84 route evidence and run/generate probe85 if MCP/game are available. |
...
- Main-thread decision: probe84 is being recorded as clean training/shadow evidence, but no new route-code change is made until Archimedes confirms whether F11/F12/F13 represent a repeatable route-commitment bug or a one-off no-alternative branch.
