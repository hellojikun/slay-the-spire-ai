...
Updated 2026-07-05 after the probe76 route-readiness validation round.
...
- Latest included probes: `ai_runs_strategy_probe77/20260705_170042_ironclad_a4.jsonl` ended as a clean F16 Guardian game-over after 210 ok actions, 1 recovered preflight mismatch, and 0 failed actions; it confirms Act 1 boss access is back but boss deck/resource quality is still brittle. `ai_runs_strategy_probe76/20260705_164024_ironclad_a4.jsonl` ended as a clean Act 2 F21 game-over after 311 ok actions, 4 recovered actions, and 0 failed actions; it beat the Act 1 boss and moved one live bottleneck to Act 2 low-HP route/combat survival plus a few recovered action races. `ai_runs_strategy_probe75/20260705_162852_ironclad_a4.jsonl` remains the clean F12 elite/readiness regression case, `ai_runs_strategy_probe74/20260705_161424_ironclad_a4.jsonl` remains the clean F10 Jaw Worm + Acid Slime potion-tempo case, and `ai_runs_strategy_probe73/20260705_160652_ironclad_a4.jsonl` remains the clean F6 Sentries route-readiness regression case.
