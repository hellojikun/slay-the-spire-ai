...
- Next live validation: use probe79 to implement and test a Guardian high-pressure draw/order rule before probe80. Active bottlenecks are boss potion/resource quality, Guardian Mode Shift planning with draw cards, Slime Boss split/minion pressure, Act 2 low-HP route/resource planning, and runner target/settle races.
