...
class HeuristicPolicy:
    ...
    def _map(self, game: dict[str, Any]) -> Decision:
        ...
        ranked = [
            (self._map_node_score(game, node, hp_ratio, floor, has_rest_choice, has_safe_choice, has_shop_choice), index, node)
    ...
    def _map_node_score(
        ...
        score = self.memory.route_score(symbol, hp_ratio, floor)
