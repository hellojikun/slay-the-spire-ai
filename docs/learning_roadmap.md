...
- As of 2026-07-05 after probe85, `slay_ai.training_manifest` can classify logs into `clean_trainable`, `diagnostic_excluded`, and `infra_blocked` before any offline learning step. The probe64-72 manifest classified 9 logs as clean, 0 diagnostic, and 0 infra-blocked, then extracted 128 route-risk rows, 484 potion-tempo rows, and 7 pre-boss deck-quality rows for shadow-model work. The probe76 manifest classified 1 clean Act 2 F21 failure and extracted 19 route-risk rows, 23 potion-tempo rows, and 1 pre-boss deck-quality row. The probe77 manifest classified 1 clean F16 Guardian failure and extracted 16 route-risk rows, 5 potion-tempo rows, and 1 pre-boss deck-quality row. The probe78 manifest classified 1 clean F16 Slime Boss failure and extracted 15 route-risk rows, 122 potion-tempo rows, and 1 pre-boss deck-quality row. The probe79 manifest classified 1 clean F16 Guardian failure and extracted 15 route-risk rows, 38 potion-tempo rows, and 2 pre-boss deck-quality rows. The probe80 manifest classified 1 clean F16 Guardian failure and extracted 15 route-risk rows, 39 potion-tempo rows, and 1 pre-boss deck-quality row. The probe81 manifest classified 1 clean F16 Hexaghost failure and extracted 15 route-risk rows, 43 potion-tempo rows, and 1 pre-boss deck-quality row. The probe82 manifest classified 1 clean F6 Gremlin Nob failure and extracted 6 route-risk rows, 43 potion-tempo rows, and 0 pre-boss deck-quality rows. The probe83 manifest classified 1 clean F16 Hexaghost failure and extracted 15 route-risk rows, 32 potion-tempo rows, and 1 pre-boss deck-quality row. The probe84 manifest classified 1 clean F16 Guardian failure and extracted 15 route-risk rows, 4 potion-tempo rows, and 1 pre-boss deck-quality row. The probe85 manifest classified 1 clean F5 hallway failure and extracted 5 route-risk rows, 27 potion-tempo rows, and 0 pre-boss deck-quality rows.
