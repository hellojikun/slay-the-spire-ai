...
- Probes94 and 95 show the A0 route is no longer blocked at the first boss: both runs cleared Act 1 and died later in Act 2. The next learning/control target should move from "reach Act 1 boss" toward Act 2 low-HP route risk, potion tempo under multi-enemy pressure, target freshness after monster death/split, and terminal-state MCP quality; do not promote broad combat action learning from these two clean A0 samples.
